...
//	if (conf_.debugOutput) manifoldManager_->checkBoundaryIntegrity();
	...
	cout << "TriangulationManager::rayTracingFromAllCam:\t\t vertices removed:\t " << verticesRemovedCount << endl;
	...
	cout << "TriangulationManager::rayTracingFromAllCam:\t\t points removed:\t " << pointsRemovedCount << endl;
...
//			cout << omp_get_thread_num() << " / " << omp_get_num_threads() << "\tu b " << cIndex_pIndex.first << ", " << cIndex_pIndex.second << endl;
			rayUntracing(getRayPath(cIndex_pIndex.first, cIndex_pIndex.second));
//			cout << omp_get_thread_num() << " / " << omp_get_num_threads() << "\tu e " << cIndex_pIndex.first << ", " << cIndex_pIndex.second << endl;
		}
...
//		std::vector<pair<int, int>> raysToBeTracedVector(raysToBeTraced_.begin(), raysToBeTraced_.end());
//		cout << "rayTracing" << endl << endl;
		// TODO check and test
//#pragma omp parallel for
//		for (int i = 0; i < raysToBeTracedVector.size(); i++) {
//
////			cout << "";
//			pair<int, int> cIndex_pIndex;
//#			pragma omp critical
//			{
//				cIndex_pIndex = raysToBeTracedVector[i];
//			}
////			cout << omp_get_thread_num() << " / " << omp_get_num_threads() << "\tt b " << cIndex_pIndex.first << ", " << cIndex_pIndex.second << endl;
//
////#pragma omp critical
////			{
...
////			cout << omp_get_thread_num() << " / " << omp_get_num_threads() << "\tt e \t" << cIndex_pIndex.first << ", " << cIndex_pIndex.second << endl;
//		}
...
//	cout << "rt:\t ray walking start\t" << omp_get_thread_num() << endl;
