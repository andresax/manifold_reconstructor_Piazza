...
public:
  ...
  */
  ...
  /*Saves the current manifold in OFF file format*/
  void saveManifoldSeparateTriangles(const std::string filename);
  ...
  float statInitSteinerGrid_ = 0.0, statShrink_ = 0.0, statInsertVertices_ = 0.0, 
    statRayTracing1_ = 0.0, statRayTracing2_ = 0.0;
