...
public:
  ...
  void writeSeparateTrianglesToOFF(const std::string filename, int lastCam = -1);
...
private:
  ...
  void tetrahedraToSeparateTriangles(std::vector<PointD3> & points, std::vector<PointD3> & tris, int lastCam = -1);
